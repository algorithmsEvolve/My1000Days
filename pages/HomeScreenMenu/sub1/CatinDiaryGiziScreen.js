...
export default class CatinDiaryGiziScreen extends React.Component {
  constructor(props) {
    super(props);
    global.x = 0;
    // get date
    ...
    global.tahunNow = "" + nowTahun;
    global.tahunNext = "" + parseInt(nowTahun + 1);
    global.tahunNext2 = "" + parseInt(nowTahun + 2);
    // end get date
    // set state
    this.state = {
      refresh: true,
  ...
  ubahItem = () => {
    ...
    for (indicator = 1; indicator <= 7; indicator++) {
      ...
      switch (indicator) {
        case 1:
          namaFileHarian = "catin_" + "senin" + "_" + fileTemp;
          break;
        case 2:
          namaFileHarian = "catin_" + "selasa" + "_" + fileTemp;
          break;
        case 3:
          namaFileHarian = "catin_" + "rabu" + "_" + fileTemp;
          break;
        case 4:
          namaFileHarian = "catin_" + "kamis" + "_" + fileTemp;
          break;
        case 5:
          namaFileHarian = "catin_" + "jumat" + "_" + fileTemp;
          break;
        case 6:
          namaFileHarian = "catin_" + "sabtu" + "_" + fileTemp;
          break;
        case 7:
          namaFileHarian = "catin_" + "minggu" + "_" + fileTemp;
          break;
        default:
          namaFileHarian = "";
      }
      ...
      AsyncStorage.getItem(namaFileHarian)
        .then((value) => {
          ...
          if (result.mp_l != "" && result.mp_l != undefined) {
            this.setState({
              ["mp_l" + indicatorAsync]: ", " + result.mp_l,
            });
          }
          if (result.ms_l != "" && result.ms_l != undefined) {
            this.setState({
              ["ms_l" + indicatorAsync]: ", " + result.ms_l,
            });
          }
          if (result.mm_l != "" && result.mm_l != undefined) {
            this.setState({
              ["mm_l" + indicatorAsync]: ", " + result.mm_l,
            });
          }
        ...
        <View style={styles.pickerView}>
          ...
          <View>
            <View style={styles.pickerStyle}>
              ...
              >
                <Picker.Item label={global.tahunNow} value={global.tahunNow} />
                <Picker.Item
                  label={global.tahunNext}
                  value={global.tahunNext}
                />
                <Picker.Item
                  label={global.tahunNext2}
                  value={global.tahunNext2}
                />
              </Picker>
            </View>
          </View>
