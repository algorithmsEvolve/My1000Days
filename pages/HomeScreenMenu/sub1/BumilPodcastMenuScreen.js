...
export default class BumilPodcastMenuScreen extends Component {
  state = {
  ...
  async componentDidMount() {
    try {
      ...
      await soundObject.loadAsync(
        require("../../../assets/podcast/podcastbumil.mp3")
      );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.titleView}>
          <Text style={styles.textTitle}>
            "Hati-hati Cans, kurang pemenuhan zat gizi bisa sebabkan bayi cacat
            lahir!"
          </Text>
        </View>
