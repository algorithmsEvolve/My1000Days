...
export default class BumilTTDMenuScreen4 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: <View></View>,
    ...
    AsyncStorage.getItem("check4")
      .then((value) => {
        ...
        if (result != null) {
          ...
          AsyncStorage.setItem("check4", JSON.stringify(checkList));
        }
      })
      .catch((error) => {
        console.log(error);
      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-46</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-47</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-48</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-49</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-50</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-51</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-52</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-53</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-54</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-55</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-56</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-57</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-58</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-59</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-60</Text>
          ...
          <View style={styles.nextPrevView}>
            ...
            <TouchableOpacity style={styles.pageButton}>
              <Text style={styles.fontActive}>4</Text>
            </TouchableOpacity>
            {/* 5 */}
            <TouchableOpacity
              style={styles.pageButton}
