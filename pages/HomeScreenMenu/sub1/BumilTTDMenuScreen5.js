...
export default class BumilTTDMenuScreen5 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: <View></View>,
    ...
    AsyncStorage.getItem("check5")
      .then((value) => {
        ...
        if (result != null) {
          ...
          AsyncStorage.setItem("check5", JSON.stringify(checkList));
        }
      })
      .catch((error) => {
        console.log(error);
      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-61</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-62</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-63</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-64</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-65</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-66</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-67</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-68</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-69</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-70</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-71</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-72</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-73</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-74</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-75</Text>
          ...
          <View style={styles.nextPrevView}>
            ...
            <TouchableOpacity style={styles.pageButton}>
              <Text style={styles.fontActive}>5</Text>
            </TouchableOpacity>
            {/* 6 */}
            <TouchableOpacity
              style={styles.pageButton}
