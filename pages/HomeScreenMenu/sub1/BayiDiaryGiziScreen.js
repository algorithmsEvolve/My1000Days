...
export default class BayiDiaryGiziScreen extends React.Component {
  constructor(props) {
    super(props);
    global.x = 0;
    // get date
  ...
  ubahItem = () => {
    ...
    for (indicator = 1; indicator <= 7; indicator++) {
      ...
      switch (indicator) {
        case 1:
          namaFileHarian = "bayi_" + "senin" + "_" + fileTemp;
          break;
        case 2:
          namaFileHarian = "bayi_" + "selasa" + "_" + fileTemp;
          break;
        case 3:
          namaFileHarian = "bayi_" + "rabu" + "_" + fileTemp;
          break;
        case 4:
          namaFileHarian = "bayi_" + "kamis" + "_" + fileTemp;
          break;
        case 5:
          namaFileHarian = "bayi_" + "jumat" + "_" + fileTemp;
          break;
        case 6:
          namaFileHarian = "bayi_" + "sabtu" + "_" + fileTemp;
          break;
        case 7:
          namaFileHarian = "bayi_" + "minggu" + "_" + fileTemp;
          break;
        default:
          namaFileHarian = "";
      }
