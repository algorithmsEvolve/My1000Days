...
export default class BumilTTDMenuScreen2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: <View></View>,
    ...
    AsyncStorage.getItem("check2")
      .then((value) => {
        ...
        if (result != null) {
          ...
          AsyncStorage.setItem("check2", JSON.stringify(checkList));
        }
      })
      .catch((error) => {
        console.log(error);
      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-16</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-17</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-18</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-19</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-20</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-21</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-22</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-23</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-24</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-25</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-26</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-27</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-28</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-29</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-30</Text>
          ...
          <View style={styles.nextPrevView}>
            ...
            <TouchableOpacity style={styles.pageButton}>
              <Text style={styles.fontActive}>2</Text>
            </TouchableOpacity>
            {/* 3 */}
            <TouchableOpacity
              style={styles.pageButton}
