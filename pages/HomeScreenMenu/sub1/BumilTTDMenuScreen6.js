...
export default class BumilTTDMenuScreen6 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: <View></View>,
    ...
    AsyncStorage.getItem("check6")
      .then((value) => {
        ...
        if (result != null) {
          ...
          AsyncStorage.setItem("check6", JSON.stringify(checkList));
        }
      })
      .catch((error) => {
        console.log(error);
      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-76</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-77</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-78</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-79</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-80</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-81</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-82</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-83</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-84</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-85</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-86</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-87</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-88</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-89</Text>
          ...
          >
            ...
            <View>
              <Text style={styles.cbTitle}>Tablet ke-90</Text>
          ...
          <View style={styles.nextPrevView}>
            ...
            <TouchableOpacity style={styles.pageButton}>
              <Text style={styles.fontActive}>6</Text>
            </TouchableOpacity>
            {/* next */}
            <TouchableOpacity style={styles.button}>
              <Text style={styles.fontActive}>Next</Text>
            </TouchableOpacity>
          </View>
          {/* jumsil */}
