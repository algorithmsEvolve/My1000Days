...
export default class CatinMenuScreen extends React.Component {
  state = {
    fontLoaded: false,
  };
          ...
          <View style={styles.menuContainer}>
            <View style={styles.titleStyle}>
              ...
              <View style={styles.verticalCenter}>
                <Text style={styles.textTitleStyle}>Catin</Text>
              </View>
            </View>
            ...
            <View>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("CatinBukuMenu")}
              >
                <View style={styles.titleStyle}>
                  <Image
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("CatinVideoMenu")}
              >
                <View style={styles.titleStyle}>
                  <Image
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("CatinGameMenu")}
              >
                <View style={styles.titleStyle}>
                  <Image
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate("CatinHitungMenu")
                }
              >
                <View style={styles.titleStyle}>
                  <Image
                  ...
                  <View style={styles.verticalCenter}>
                    <Text style={styles.menuTitleStyle}>
                      Hitung BB Ideal dan IMT
                    </Text>
                  </View>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("CatinDiaryMenu")}
              >
                <View style={styles.titleStyle2}>
                  ...
                  />
                  <View style={styles.verticalCenter}>
                    <Text style={styles.menuTitleStyle}>Diary Gizi Catin</Text>
                  </View>
                </View>
              </TouchableOpacity>
            </View>
